...
export const tools: ToolDefinition[] = [
  ...
  tool('json-compare', 'development', 'JSON', 'local', 'JSON compare', 'Compare two JSON documents locally and detect added, removed and changed paths.', 'Comparador JSON', 'Compara dos JSON localmente y detecta rutas añadidas, eliminadas y modificadas.', { search: 'json compare comparator diff comparar json diferencias object array paths cambios añadido eliminado modificado' }),
