...
export const tools: ToolDefinition[] = [
  ...
  tool('ai-text-detector','writing','AI','local','AI text detector','Estimate whether a text may have been generated by AI with a RoBERTa model running in the browser.','Detector de textos con IA','Estima si un texto puede haber sido generado por IA con un modelo RoBERTa ejecutado en el navegador.',{search:'ai detector text roberta transformers detectar texto ia inteligencia artificial openai detector'}),
